...
#define OCTAVES 20     // How many passes of fractal Brownian motion to perform
#define GAIN 0.2       // How much should each pixel move
#define LACUNARITY 1.5 // How fast should each ripple be per pass
